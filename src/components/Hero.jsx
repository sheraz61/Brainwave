                ...
                <div className='relative  max-w-[23rem] mx-auto md:max-w-5xl xl:mb-24 '>
                    <div className='relative z-1 p-0.5 rounded-2xl bg-conic-gradient'>
                        <div className='relative bg-n-8 rounded-[1rem] '>
                            ...
                            <div className='aspect-[33/40] rounded-b-[0.9rem] overflow-hidden md:aspect-[688/419] lg:aspect-[1024/490]'>
                                <img
                                    src={robot}
                    ...
                    <div className='absolute -top-[54%] left-1/2 w-[234%] -translate-x-1/2 md:-top-[46%] md:w-[135%] lg:-top-[104%] '>
